  ...
  const structuredData = [
    {
      ...
      "@type": "WebSite",
      "name": "KukeMC",
      "alternateName": "KukeMC-我的世界服务器",
      "url": "https://kuke.ink",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://kuke.ink/activity?q={search_term_string}",
    ...
    },
    {
      ...
      "name": "KukeMC",
      "url": "https://kuke.ink",
      "logo": "https://kuke.ink/logo.webp",
      "sameAs": [
        "https://space.bilibili.com/3546652948302452",
        "https://github.com/kukemc/KukeMC-WebSite",
        "https://klpbbs.com/thread-151387-1-1.html",
        "https://www.minebbs.com/threads/1-6-1-21-kukemc.29497/"
      ]
    }
  ];
